...
## Dependencies
This repository is my Udacity Self-Driving Car Nanodegree Model Predictive Control project. The goal of the project is to implement Model Predictive Control to drive the car around the track. My solution makes use of Ipopt and  CppAd labraries to solve the optimal trajectory in order to minimize the cost function. 
